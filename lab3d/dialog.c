...
int addInfo_In(TableHHD *table, TableHash *searchTable) {
...
int deleteOldVersions_In(TableHHD *table) {
    ...
    if(deleteOldVersionsHHD(table, key)){
        printf("\n(X) Ключ не найден\n");
    } else {
        printf("\n(OK) Успешно\n");
    }
...
int delete_In(TableHHD *table, TableHash *search) {
    int (*func[])(TableHHD *) = {NULL, deleteKey_In, deleteOldVersions_In};
...
TableHash* printTableSearch_In(TableHHD *table, TableHash *search) {
    if(search != NULL) {
        printTH(search);
    } else {
...
TableHash* searchKey_In(TableHHD *table, TableHash *search) {
    char *key = NULL;
...
TableHash *searchKeyVersion_In(TableHHD *table, TableHash *search) {
    char *errorMessage = "";
    char *string = NULL;
    char *key = NULL;
    int version = 0;
...
int search_In(TableHHD *table, TableHash *search) {
    TableHash* (*func[])(TableHHD *, TableHash *) = {NULL, searchKey_In, searchKeyVersion_In, printTableSearch_In};
